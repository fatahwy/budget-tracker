  ...
  return (
    <Card className="max-w-2xl">
      <CardHeader className='flex justify-between'>
        ...
        <Button onClick={() => router.push("/accounts/new")} className='flex items-center' title='Add Account'>
          <Plus />
          Account
        </Button>
      </CardHeader>
                            ...
                            <div className='flex gap-1 justify-end'>
                              {editing === a.id ? (
                                ...
                                <>
                                  ...
                                  <Button title='Delete' variant='danger' onClick={() => deleteAccount(a.id)}><Trash size={14} /></Button>
                                </>
                              )}
                            </div>
                          </td>
